...
if __name__ == "__main__":
    ...
    # if True:
        ...
        for init_model in ['pretraining']:
            ...
            for database_name,database_name_train in [['drive','stare']]:
                
                
                tmp_train = DataSpliter.filter_database(data_split['train'],database_name_train)
                tmp_valid = DataSpliter.filter_database(data_split['valid'],database_name_train)
                ...
                config.model_name_load = 'sdfdfds'
                # config.model_name_load = init_modelx
                config.multiply_dataset = 100
                
                model_name = '../best_models/segmentation_separatedrive_48_0.00000_gpu_10.43176_train_0.10997_valid_0.10789.pt'
            ...
            with open(config.results_folder + '/result_'  + init_model + '.json', 'w') as outfile:
